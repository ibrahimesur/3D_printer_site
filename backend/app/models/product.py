...
class Product(Base):
    ...
    design_id = Column(Integer, ForeignKey("designs.id"), nullable=True, index=True) # Bağlı olduğu tasarım
    creator_id = Column(Integer, ForeignKey("users.id"), nullable=True, index=True) # Ürünün sahibi (üretici)
