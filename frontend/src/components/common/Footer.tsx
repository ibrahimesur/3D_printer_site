        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-3 pt-1">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-full bg-gray-100 hover:bg-orange-50 hover:text-orange-500 flex items-center justify-center text-gray-400 transition-colors">
          ...
          {/* Categories Block */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-2.5 text-xs uppercase tracking-wider">Kategoriler</h3>
            <ul className="space-y-1.5 text-xs">
              <li>
                <Link href="/" className="hover:text-orange-500 transition-colors">Tümü</Link>
              </li>
              {CATEGORIES.slice(0, 5).map((category) => (
                <li key={category.slug}>
                  <Link href={`/category/${category.slug}`} className="hover:text-orange-500 transition-colors">
                    {category.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2.5 text-xs uppercase tracking-wider">Müşteri Hizmetleri</h3>
            <ul className="space-y-1.5 text-xs">
              ...
              <li><Link href="/" className="hover:text-orange-500 transition-colors">İade ve İptal Koşulları</Link></li>
              <li><Link href="/" className="hover:text-orange-500 transition-colors">Destek Talebi / İletişim</Link></li>
            </ul>
          </div>

          {/* Corporate / Producer Block */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-2.5 text-xs uppercase tracking-wider">Kurumsal & Yasal</h3>
            <ul className="space-y-1.5 text-xs">
              ...
              <li><Link href="/" className="hover:text-orange-500 transition-colors">Gizlilik ve KVKK Politikası</Link></li>
            </ul>
          </div>
        </div>
